...
class Quiz:
    ...
    def lancer_Quiz(self):
        ...
        while self.index_question < len(self.questions_reponses):
            ...
            correction_question(correction=self.correction, reponse_user=self.reponses_user_questions, index_question= self.index_question, identifiant=self.identifiant)
