...
questions_reponses_domaine_maths = {"Si deux entiers naturels a et b sont premiers ente eux alors":
                           ["pgcd(a,b)=1", "pgcd(a,b)*ppcm(a,b)=a*b", "ppcm(a,b) = a*b"],
                             ...
                             "Une matrice est inverssible lorsque:" :
                               ["lorsqu'elle est une matrice carrée", "lorsque son déterminant est nul", "lorsque son déterminant est non nul"],
